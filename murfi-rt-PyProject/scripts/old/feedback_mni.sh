...
then
    clear
        echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
        echo "+ Generating DMN & CEN Masks MNI"
        echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
...
then
    clear
    echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
    echo "+ Registering masks to study_ref mni"
    
    # Find the latest series*_ref.nii file, excluding study_ref2series files
    latest_ref=$(ls -t $subj_dir/xfm/series*_ref.nii 2>/dev/null | grep -v "study_ref2" | head -n1)
